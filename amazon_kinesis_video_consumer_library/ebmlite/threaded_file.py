...
class ThreadAwareFile(io.FileIO):
    ...
    def truncate(self, *args, **kwargs):
        raise IOError("Can't truncate(); %s is read-only" % self.__class__.__name__)

    def write(self, *args, **kwargs):
        raise IOError("Can't write(); %s is read-only" % self.__class__.__name__)

    def writelines(self, *args, **kwargs):
        raise IOError("Can't writelines(); %s is read-only" % self.__class__.__name__)
